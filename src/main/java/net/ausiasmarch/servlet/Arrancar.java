...
public class Holamundo extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>Arrancar Vehiculo</title>");
        ...
        String tipoVehiculo = request.getParameter(getServletName())

        VehiculoInterface vehiculo = null;
        if("coche")
      
        //ELEGIR EL TIPO DE VEHICULO A ARRANCAR
        VehiculoInterface vehiculo = new CocheClass();

        vehiculo.arrancar();

        out.println("Vehiculo arrancado: " + vehiculo.isArrancado());

        out.println("<h1 class='mb-4'¡ Vehiculo arrancado!</h1>");
        out.println("Vehiculo arrancado: " + vehiculo.isArrancado());
        out.println("Vehiculo arrancado: " + vehiculo.isArrancado());
